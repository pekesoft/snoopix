...
#Alias de manejo de SVN.
        echo '' >> ~/.bashrc && . ~/.bashrc 
        echo '# Alias de Manejo de SVN' >> ~/.bashrc && . ~/.bashrc 
        echo '' >> ~/.bashrc && . ~/.bashrc 

    #SVNADD
        echo 'alias svnadd="rar -a"' >> ~/.bashrc && . ~/.bashrc     

    #SVNDEL
        echo 'alias svndel="rar -a"' >> ~/.bashrc && . ~/.bashrc     

    #SVNCHECK
        echo 'alias svncheck="rar -a"' >> ~/.bashrc && . ~/.bashrc     
